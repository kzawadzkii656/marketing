...
export const groups=[
 {name:'Lokalizacja',fields:[['city','Miasto','text'],['region','Województwo','choice',[['','Nie wiem'],['dolnośląskie','Dolnośląskie'],['kujawsko-pomorskie','Kujawsko-pomorskie'],['lubelskie','Lubelskie'],['lubuskie','Lubuskie'],['łódzkie','Łódzkie'],['małopolskie','Małopolskie'],['mazowieckie','Mazowieckie'],['opolskie','Opolskie'],['podkarpackie','Podkarpackie'],['podlaskie','Podlaskie'],['pomorskie','Pomorskie'],['śląskie','Śląskie'],['świętokrzyskie','Świętokrzyskie'],['warmińsko-mazurskie','Warmińsko-Mazurskie'],['wielkopolskie','Wielkopolskie'],['zachodniopomorskie','Zachodniopomorskie']]]]},
